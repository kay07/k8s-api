...
func DepYaml(name string,replicas string) []byte {
	//设置环境变量
	type EnvKv struct{
        ...
        "template":{
            ...
            "spec":{
                "containers":[
                    {
                        "name":`+name+`,
                        "image":"10.36.31.157:8802/api/elco-zhuchi-eam-import:prod",
                        ...
                        "env":[
                            ...
                            },
                            {
                                ...
                                "value":"10.36.31.157:30100"
                            },
                            {
                                "name":"spring.cloud.nacos.discovery.namespace",
                                "value":"f304cf7b-6b05-4e4c-b333-432421127d87"
                            },
                            {
